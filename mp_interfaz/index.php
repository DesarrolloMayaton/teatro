...
<body>
    ...
    <a href="../admin_interfaz/Ajs_interfaz/index.php"
        style="position: fixed; bottom: 16px; left: 16px; padding: 10px 16px; background: #334155; color: #f1f5f9; border-radius: 10px; text-decoration: none; font-weight: 600; display: flex; align-items: center; gap: 8px; z-index: 9999;">
