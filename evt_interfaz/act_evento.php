...
<style>
    ...
    .event-card:hover .card-img { transform: scale(1.08); }
    ...
    .funcs-container::-webkit-scrollbar-thumb { background: var(--border-color); border-radius: 3px; }
    ...
    <div class="events-grid">
        ...
        <div class="event-card" style="animation-delay: <?= $delay ?>ms">
            <div class="card-img-container">
                <?php if($img): ?>
                    <img src="<?= htmlspecialchars($img) ?>" class="card-img" loading="lazy" alt="<?= htmlspecialchars($e['titulo']) ?>">
                <?php else: ?>
            ...
            <div class="card-body">
                ...
                <div class="funcs-container">
                    <?php if(count($funciones) > 0): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <span class="func-badge" style="background: var(--danger-bg); color: var(--danger); border: 1px solid rgba(255,69,58,0.3);">Sin funciones</span>
                    <?php endif; ?>
                </div>
            </div>
            
            <div class="card-footer">
                <button onclick="window.location.href='editar_evento.php?id=<?= $e['id_evento'] ?>'" class="btn-card primary">
